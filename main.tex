...
\date{2024}{1}{24}%{Year}{Month}{Day}%use numbers
...
\begin{abstract}
  ...
  Since contemporary information-retrieval systems rely heavily on the content of titles and abstracts to identify relevant articles in literature searches, great care should be taken in constructing both~\cite{edp2023matexlatextemplate}.
